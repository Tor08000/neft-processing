  ...
  return (
    <section className="neft-card" style={{ padding: 16 }}>
      ...
      <div style={{ display: "grid", gap: 8 }}>
        <MetricRow label="Exports queued" value={queues.exports.queued} to="/runtime" />
        <MetricRow label="Exports running" value={queues.exports.running} to="/runtime" />
        <MetricRow label="Exports failed (1h)" value={queues.exports.failed_1h} to="/ops/exports/failed" />
        <MetricRow label="Payouts queued" value={queues.payouts.queued} to="/finance/payouts" />
        <MetricRow label="Payouts blocked" value={queues.payouts.blocked} to="/ops/payouts/blocked" />
        <MetricRow label="Settlements queued" value={queues.settlements.queued} to="/finance" />
        <MetricRow label="Settlements finalizing" value={queues.settlements.finalizing} to="/finance" />
        <MetricRow label="Emails queued" value={queues.emails.queued} to="/runtime" />
        <MetricRow label="Emails failed (1h)" value={queues.emails.failed_1h} to="/runtime" />
        <MetricRow label="Helpdesk outbox queued" value={queues.helpdesk_outbox.queued} to="/cases?queue=SUPPORT" />
        <MetricRow
          label="Helpdesk outbox failed (1h)"
          value={queues.helpdesk_outbox.failed_1h}
          to="/cases?queue=SUPPORT"
        />
      </div>
