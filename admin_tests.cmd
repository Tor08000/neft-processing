...
curl -s -H "Authorization: Bearer %TOKEN%" ^
  "http://localhost/api/v1/admin/operations?limit=5&offset=0"
echo.
echo.
...
curl -s -H "Authorization: Bearer %TOKEN%" ^
  "http://localhost/api/v1/admin/transactions?limit=5&offset=0"
echo.
echo.
...
curl -s -H "Authorization: Bearer %TOKEN%" ^
  "http://localhost/api/v1/admin/operations?operation_type=REFUND&limit=10"
echo.
echo.
...
curl -s -H "Authorization: Bearer %TOKEN%" ^
  "http://localhost/api/v1/admin/transactions?client_id=CLIENT-123&limit=10"
echo.
echo.
...
curl -s -H "Authorization: Bearer %TOKEN%" ^
  "http://localhost/api/v1/admin/operations?order_by=amount_desc&limit=10"
echo.
echo.
