...
| auth-host | `neft-processing-auth-host-1` | `platform/auth-host/Dockerfile` | `8002:8000` | `GET /api/auth/health` | `GET /api/v1/metrics` | postgres, redis | JWT/identity/bootstrap. (`platform/auth-host/app/main.py`) |
