...
if not "!LAST_STATUS!"=="200" call :fail "%STEP%"
call :extract_json_field "%TEMP%\admin_login.json" "access_token" ADMIN_TOKEN
...
set "STEP=10_partner_payout_detail"
