...
from app.routers.partner.gamification import router as partner_gamification_router
...
app.include_router(partner_gamification_router, prefix=LEGACY_API_PREFIX)
app.include_router(partner_gamification_router, prefix=API_PREFIX_CORE)
