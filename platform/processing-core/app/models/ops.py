...
class OpsEscalation(Base):
    ...
    ack_reason_code = Column(String(64), nullable=True)
    ack_reason_text = Column("ack_reason", String(512), nullable=True)
    closed_at = Column(DateTime(timezone=True), nullable=True)
    closed_by = Column(String(128), nullable=True)
    close_reason_code = Column(String(64), nullable=True)
    close_reason_text = Column("close_reason", String(512), nullable=True)
    ...
    unified_explain_snapshot_hash = Column(String(64), nullable=True)
    unified_explain_snapshot = Column(JSON, nullable=True)
