...
CONFIDENCE_MIN_AFTER_DECAY = 0.35
CONFIDENCE_STATUS_HIGH = 0.7
CONFIDENCE_STATUS_MEDIUM = 0.45
INSIGHT_ESCALATION_NO_CHANGE_DAYS = 14
...
__all__ = [
    ...
    "CONFIDENCE_MIN_AFTER_DECAY",
    "CONFIDENCE_STATUS_HIGH",
    "CONFIDENCE_STATUS_MEDIUM",
    "INSIGHT_ESCALATION_NO_CHANGE_DAYS",
    "InsightThresholds",
    "EffectThresholds",
]
