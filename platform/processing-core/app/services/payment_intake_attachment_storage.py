...
class PaymentIntakeUpload:
    bucket: str
    object_key: str
    upload_url: str


class PaymentIntakeAttachmentStorage:
    ...
    def normalize_filename(file_name: str) -> str:
        ...
        return clean or "payment-proof"

    def build_object_key(self, *, invoice_id: int, intake_id: str, file_name: str) -> str:
        safe_name = self.normalize_filename(file_name)
        return f"billing-payment-intakes/{invoice_id}/{intake_id}/{safe_name}"
