    ...
    if not table_exists(bind, "logistics_orders", schema=SCHEMA):
        op.create_table(
            ...
            sa.Column(
                "order_type",
                postgresql.ENUM(
                    *LOGISTICS_ORDER_TYPE,
                    name="logistics_order_type",
                    schema=SCHEMA,
                    create_type=False,
                ),
                nullable=False,
    ...
    if not table_exists(bind, "logistics_stops", schema=SCHEMA):
        op.create_table(
            ...
            sa.Column(
                "status",
                postgresql.ENUM(
                    *LOGISTICS_STOP_STATUS,
                    name="logistics_stop_status",
                    schema=SCHEMA,
                    create_type=False,
                ),
                nullable=False,
