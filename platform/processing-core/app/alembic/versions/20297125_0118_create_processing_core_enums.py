...
PROCESSING_ENUMS = {
    ...
    'fuel_anomaly_status': ('OPEN', 'ACKED', 'IGNORED'),
    'fuel_anomaly_type': ('SPIKE_AMOUNT', 'SPIKE_VOLUME', 'NEW_MERCHANT', 'MERCHANT_OUTLIER', 'TIME_OF_DAY', 'FREQUENCY_BURST', 'GEO_DISTANCE', 'REPEATED_BREACH'),
    'fuel_card_group_status': ('ACTIVE', 'INACTIVE'),
    'fuel_card_status': ('ACTIVE', 'BLOCKED', 'LOST', 'EXPIRED', 'CLOSED'),
    'fuel_card_status_actor_type': ('system', 'user'),
    'fuel_fraud_signal_type': ('FUEL_OFF_ROUTE_STRONG', 'FUEL_STOP_MISMATCH_STRONG', 'MULTI_CARD_SAME_STATION_BURST', 'REPEATED_NIGHT_REFUEL', 'TANK_SANITY_REPEAT', 'STATION_OUTLIER_CLUSTER', 'DRIVER_VEHICLE_MISMATCH', 'ROUTE_DEVIATION_BEFORE_FUEL'),
    'fuel_ingest_job_status': ('RECEIVED', 'PROCESSED', 'FAILED'),
    'fuel_ingest_mode': ('POLL', 'BACKFILL', 'REPLAY', 'EDI'),
    ...
    'fuel_limit_escalation_status': ('TRIGGERED', 'APPLIED', 'FAILED'),
    ...
    'fuel_provider_auth_type': ('API_KEY', 'OAUTH2', 'EDI'),
    'fuel_provider_connection_status': ('ACTIVE', 'DISABLED', 'ERROR'),
