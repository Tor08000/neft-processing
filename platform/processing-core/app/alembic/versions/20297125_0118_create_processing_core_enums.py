...
PROCESSING_ENUMS = {
    ...
    'fleet_action_policy_breach_kind': ('SOFT', 'HARD', 'ANY'),
    ...
    'fleet_notification_channel_type': ('WEBHOOK', 'EMAIL', 'PUSH', 'TELEGRAM', 'SMS', 'VOICE'),
    ...
    'fleet_notification_outbox_status': ('PENDING', 'SENT', 'FAILED', 'DEAD'),
