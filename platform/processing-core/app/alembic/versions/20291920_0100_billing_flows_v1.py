...
def upgrade() -> None:
    ...
    create_table_if_not_exists(
        ...
        sa.Column("status", safe_enum("billing_invoice_status", BILLING_INVOICE_STATUS), nullable=False),
    ...
    create_table_if_not_exists(
        ...
        sa.Column("status", safe_enum("billing_payment_status", BILLING_PAYMENT_STATUS), nullable=False),
        sa.Column("idempotency_key", sa.String(length=128), nullable=False),
        sa.Column("ledger_tx_id", GUID(), nullable=False),
    ...
    create_table_if_not_exists(
        ...
        sa.Column("status", safe_enum("billing_refund_status", BILLING_REFUND_STATUS), nullable=False),
        sa.Column("idempotency_key", sa.String(length=128), nullable=False),
        sa.Column("ledger_tx_id", GUID(), nullable=False),
        sa.Column("external_statement_line_id", sa.String(length=128), nullable=True),
        sa.Column("audit_event_id", GUID(), nullable=False),
    ...
    create_table_if_not_exists(
        ...
        sa.Column(
            "direction",
            safe_enum("reconciliation_link_direction", RECONCILIATION_LINK_DIRECTION),
            nullable=False,
        ),
        ...
        sa.Column(
            "status",
            safe_enum("reconciliation_link_status", RECONCILIATION_LINK_STATUS),
            nullable=False,
        ),
