...
def upgrade() -> None:
    ...
    create_table_if_not_exists(
        ...
        sa.Column("status", safe_enum("settlement_account_status", SETTLEMENT_ACCOUNT_STATUS), nullable=False),
    ...
    create_table_if_not_exists(
        ...
        sa.Column("status", safe_enum("settlement_period_status", SETTLEMENT_PERIOD_STATUS), nullable=False),
    ...
    create_table_if_not_exists(
        ...
        sa.Column("source_type", safe_enum("settlement_item_source_type", SETTLEMENT_ITEM_SOURCE_TYPE), nullable=False),
        sa.Column("source_id", GUID(), nullable=False),
        sa.Column("amount", sa.Numeric(18, 4), nullable=False),
        sa.Column("direction", safe_enum("settlement_item_direction", SETTLEMENT_ITEM_DIRECTION), nullable=False),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False, server_default=sa.func.now()),
    ...
    create_table_if_not_exists(
        ...
        sa.Column("currency", sa.String(length=8), nullable=False),
        sa.Column("amount", sa.Numeric(18, 4), nullable=False),
        sa.Column("status", safe_enum("payout_status", PAYOUT_STATUS), nullable=False),
