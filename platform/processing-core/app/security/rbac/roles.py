...
ROLE_PERMISSIONS = {
    "admin": {
        ...
        Permission.PARTNER_FINANCE_VIEW.value,
        Permission.PARTNER_PAYOUTS_REQUEST.value,
        Permission.PARTNER_DOCUMENTS_LIST.value,
        Permission.PARTNER_FINANCE_VIEW.value,
        Permission.PARTNER_PAYOUTS_REQUEST.value,
        Permission.PARTNER_DOCUMENTS_LIST.value,
    ...
    "partner_user": {
        ...
        Permission.PARTNER_PROFILE_VIEW.value,
        Permission.PARTNER_PROFILE_MANAGE.value,
        Permission.PARTNER_OFFERS_LIST.value,
        Permission.PARTNER_OFFERS_MANAGE.value,
        Permission.PARTNER_ORDERS_LIST.value,
        Permission.PARTNER_ORDERS_VIEW.value,
        Permission.PARTNER_ORDERS_UPDATE.value,
        Permission.PARTNER_ANALYTICS_VIEW.value,
    },
    "client_admin": {
        Permission.CLIENT_DASHBOARD_VIEW.value,
        Permission.CLIENT_INVOICES_LIST.value,
