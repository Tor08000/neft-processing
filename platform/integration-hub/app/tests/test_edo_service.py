...
from app.models import EdoDocumentStatus
from app.schemas import DispatchRequest
from app.services.edo_service import dispatch_request, poll_document, send_document
...
def test_poll_transitions_after_send(monkeypatch):
    ...
    monkeypatch.setattr("app.services.edo_service._load_artifact_bytes", _fake_bytes)
